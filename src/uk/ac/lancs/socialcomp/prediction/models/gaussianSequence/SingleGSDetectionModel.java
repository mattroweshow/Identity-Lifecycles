 ...
 */
public class SingleGSDetectionModel implements PredictionModel, FeatureProperties {
    ...
    public SingleGSDetectionModel(double lambda, double eta, double rho, double epsilon, int m, Dataset trainingData) {
        this.lambda = lambda;
        this.eta = eta;
        this.rho = rho;
...
//                double nonChurnProb = gs.getNonChurnGaussianSequence().get(featureIndex).calcProb(feature.getValue());
                ...
                double innerChurnProb = b.get(featureIndex) * churnProb;
...
//                double nonChurnProb = gs.getNonChurnGaussianSequence().get(featureIndex).calcProb(feature.getValue());
                ...
                double innerChurnProb = betaCoef * churnProb;
