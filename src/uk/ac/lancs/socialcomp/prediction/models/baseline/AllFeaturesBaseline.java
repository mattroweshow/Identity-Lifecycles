 ...
 */
public class AllFeaturesBaseline {
    String platform;
...
//            System.out.println("\nP: Loading weka datasets");
            ...
            for (int k : ks) {
                ...
                Instances train = datasetBuilder.buildWekaDataset("train",k, true);

                // load the test dataset for the platform
                Instances test = datasetBuilder.buildWekaDataset("test", k, true);
...
//        String[] platforms = {"boards"};
        AllFeaturesBaseline j48 = new AllFeaturesBaseline();
