 ...
 * Date / Time : 15/05/2013 / 15:30
 */
public class InitiationDistribution {
    ...
    public void deriveActivityPerStageDistributions() {
        ...
        try {
            ...
            PrintWriter writer = new PrintWriter("data/logs/" + DB + "_initiation_stages.tsv");
...
//            System.out.println("Window = [" + startWindow + "] ---> [" + endWindow + "]");
    ...
    public static void main(String[] args) {
        ...
        InitiationDistribution initiationDistribution = new InitiationDistribution();
        initiationDistribution.deriveActivityPerStageDistributions();
