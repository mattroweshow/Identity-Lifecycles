...
public class ActivityDistribution {
    ...
    public void deriveActivityPerStageDistributions() {
        ...
        try {
            ...
            PrintWriter writer = new PrintWriter("data/logs/" + DB + "_activity_stages.tsv");
...
//            System.out.println("Window = [" + startWindow + "] ---> [" + endWindow + "]");
    ...
    public static void main(String[] args) {
        ...
        ActivityDistribution activityDistribution = new ActivityDistribution();
        activityDistribution.deriveActivityPerStageDistributions();
